...
describe('Directive Test\n', function() {
    it('Should initialize comments div with 2 comments',
        inject(function($rootScope, $compile) {
            ...
            }; // Fake comments array in a fake post instance
            ...
            expect(window.jQuery(elem).find('.single-comment').length).toBe(2); // Expect number of comments to be 2
        }));
});
